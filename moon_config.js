...
moon_config.debug = true; // for additional logging / debugging
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//      SET SOME PARAMETERS TO THIS CONFIG FOR THE MOON STRATEGIE
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
moon_config.tradingAdvisor = {
  enabled: true,
  method: 'moon',
  candleSize: 60 ,  // "60 * 24" would be a candle per day
  historySize: 10,
}
...
moon_config.performanceAnalyzer = {
  enabled: true,
  riskFreeReturn: 5
}
...
moon_config.candleWriter = {
  enabled: true
}

moon_config.adviceWriter = {
  enabled: false,
  muteSoft: true,
}

moon_config.backtestResultExporter = {
  enabled: false,
  writeToDisk: false,
  data: {
    stratUpdates: false,
...
// Postgres adapter example moon_config (please note: requires postgres >= 9.5):
moon_config.postgresql = {
...
// Uses settings from the ppo and momentum indicator moon_config block
moon_config.varPPO = {
...
moon_config['I understand that Gekko only automates MY OWN trading strategies'] = false;

module.exports = moon_config;
